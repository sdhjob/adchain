...
(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism,
 CK_OBJECT_HANDLE hWrappiadey, CK_OBJECT_HANDLE hKey, CK_BYTE_PTR pWrappedKey,
 CK_ULONG_PTR pulWrappedKeyLen) {
  ...
  int wrapping_key_type = hWrappiadey >> 16;
...
(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism,
 CK_OBJECT_HANDLE hUnwrappiadey, CK_BYTE_PTR pWrappedKey,
 ...
 CK_ULONG ulAttributeCount, CK_OBJECT_HANDLE_PTR phKey) {
  ...
  int unwrapping_key_type = hUnwrappiadey >> 16;
