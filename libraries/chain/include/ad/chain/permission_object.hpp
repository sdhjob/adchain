...
CHAINBASE_SET_INDEX_TYPE(ad::chain::permission_object, ad::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(ad::chain::permission_usage_object, ad::chain::permission_usage_index)

FC_REFLECT(ad::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(ad::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(ad::chain::permission_usage_object, (last_used))
