...
FC_REFLECT(ad::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(ad::chain::key_weight, (key)(weight) )
FC_REFLECT(ad::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(ad::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(ad::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(ad::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(ad::chain::shared_public_key, (pubkey))