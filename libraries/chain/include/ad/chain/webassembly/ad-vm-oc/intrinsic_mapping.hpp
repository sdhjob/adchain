...
constexpr auto intrinsic_table = boost::hana::make_tuple(
   "advmoc_internal.unreachable"_s,
   "advmoc_internal.grow_memory"_s,
   "advmoc_internal.div0_or_overflow"_s,
   "advmoc_internal.indirect_call_mismatch"_s,
   "advmoc_internal.indirect_call_oob"_s,
   "advmoc_internal.depth_assert"_s,
   "eosio_injection.call_depth_assert"_s,  //these two are never used by AD VM OC but all intrinsics
