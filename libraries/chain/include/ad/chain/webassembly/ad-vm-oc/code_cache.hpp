...
namespace std {
    template<> struct hash<ad::chain::advmoc::code_tuple> {
        size_t operator()(const ad::chain::advmoc::code_tuple& ct) const noexcept {
...
class code_cache_base {
   public:
      code_cache_base(const bfs::path data_dir, const advmoc::config& advmoc_config, const chainbase::database& db);
      ~code_cache_base();
...
class code_cache_async : public code_cache_base {
   public:
      code_cache_async(const bfs::path data_dir, const advmoc::config& advmoc_config, const chainbase::database& db);
      ~code_cache_async();
