...
using advmoc_message = fc::static_variant<initialize_message,
...
FC_REFLECT(ad::chain::advmoc::initialize_message, )
FC_REFLECT(ad::chain::advmoc::initalize_response_message, (error_message))
FC_REFLECT(ad::chain::advmoc::code_tuple, (code_id)(vm_version))
FC_REFLECT(ad::chain::advmoc::compile_wasm_message, (code))
FC_REFLECT(ad::chain::advmoc::evict_wasms_message, (codes))
FC_REFLECT(ad::chain::advmoc::code_compilation_result_message, (start)(apply_offset)(starting_memory_pages)(initdata_prologue_size))
FC_REFLECT(ad::chain::advmoc::compilation_result_unknownfailure, )
FC_REFLECT(ad::chain::advmoc::compilation_result_toofull, )
FC_REFLECT(ad::chain::advmoc::wasm_compilation_result_message, (code)(result)(cache_free_bytes))