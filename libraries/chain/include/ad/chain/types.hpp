...
namespace ad { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in AD code:
    *
    ...
    *  others are due to requirements to ensure determinism in the AD chain library.
    *
...
FC_REFLECT_EMPTY( ad::chain::void_t )
