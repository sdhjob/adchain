...
#include <ad/chain/action_receipt.hpp>
...
FC_REFLECT( ad::chain::account_delta,
            (account)(delta) )

FC_REFLECT( ad::chain::action_trace,
...
FC_REFLECT( ad::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
