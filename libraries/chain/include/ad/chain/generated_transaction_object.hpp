...
CHAINBASE_SET_INDEX_TYPE(ad::chain::generated_transaction_object, ad::chain::generated_transaction_multi_index)

FC_REFLECT(ad::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))
