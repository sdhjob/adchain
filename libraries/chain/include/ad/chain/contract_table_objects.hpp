...
#include <ad/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(ad::chain::table_id_object, ad::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(ad::chain::key_value_object, ad::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(ad::chain::index64_object, ad::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(ad::chain::index128_object, ad::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(ad::chain::index256_object, ad::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(ad::chain::index_double_object, ad::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(ad::chain::index_long_double_object, ad::chain::index_long_double_index)

FC_REFLECT(ad::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(ad::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(ad::chain::index64_object)
REFLECT_SECONDARY(ad::chain::index128_object)
REFLECT_SECONDARY(ad::chain::index256_object)
REFLECT_SECONDARY(ad::chain::index_double_object)
REFLECT_SECONDARY(ad::chain::index_long_double_object)
