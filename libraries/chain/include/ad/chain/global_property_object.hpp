...
#include <ad/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(ad::chain::global_property_object, ad::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(ad::chain::dynamic_global_property_object,
                         ad::chain::dynamic_global_property_multi_index)

FC_REFLECT(ad::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(ad::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(ad::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(ad::chain::dynamic_global_property_object,
