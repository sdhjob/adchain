...
CHAINBASE_SET_INDEX_TYPE(ad::chain::permission_link_object, ad::chain::permission_link_index)

FC_REFLECT(ad::chain::permission_link_object, (account)(code)(message_type)(required_permission))
