...
FC_REFLECT_ENUM( ad::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(ad::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(ad::chain::transaction_receipt, (ad::chain::transaction_receipt_header), (trx) )
FC_REFLECT(ad::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(ad::chain::signed_block, (ad::chain::signed_block_header), (transactions)(block_extensions) )
