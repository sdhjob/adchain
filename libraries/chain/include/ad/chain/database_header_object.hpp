...
namespace ad { namespace chain {
      ...
      class database_header_object : public chainbase::object<database_header_object_type, database_header_object>
      {
         ...
         void validate() const {
            AD_ASSERT(std::clamp(version, minimum_version, current_version) == version, bad_database_version_exception,
...
CHAINBASE_SET_INDEX_TYPE(ad::chain::database_header_object, ad::chain::database_header_multi_index)

FC_REFLECT( ad::chain::database_header_object, (version) )
