...
CHAINBASE_SET_INDEX_TYPE(ad::chain::code_object, ad::chain::code_index)

FC_REFLECT(ad::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
