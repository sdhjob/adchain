...
#define ADVMOC_MEMORY_PTR_cb_ptr GS_PTR struct ad_vm_oc_control_block* const cb_ptr = ((GS_PTR struct ad_vm_oc_control_block* const)(AD_VM_OC_CONTROL_BLOCK_OFFSET));

int32_t ad_vm_oc_grow_memory(int32_t grow, int32_t max) {
   ADVMOC_MEMORY_PTR_cb_ptr;
   ...
   current_gs += grow_amount * AD_VM_OC_MEMORY_STRIDE;
