...
#include <ad/vm/error_codes.hpp>
#include <ad/vm/host_function.hpp>
#include <ad/vm/watchdog.hpp>
...
/**
 * Simple implementation of an interpreter using ad-vm.
 */
int main(int argc, char** argv) {
   ...
   using backend_t = ad::vm::backend<example_host_methods>;
   using rhf_t     = ad::vm::registered_host_functions<example_host_methods>;
   ...
   } catch (...) { std::cerr << "ad-vm interpreter error\n"; }
   return 0;
}
