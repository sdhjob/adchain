...
CHAINBASE_SET_INDEX_TYPE( ad::account_control_history_object, ad::account_control_history_multi_index )

FC_REFLECT( ad::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
