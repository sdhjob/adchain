...
CHAINBASE_SET_INDEX_TYPE( ad::public_key_history_object, ad::public_key_history_multi_index )

FC_REFLECT( ad::public_key_history_object, (public_key)(name)(permission) )
