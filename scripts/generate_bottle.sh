...
mkdir -p ${PROJECT}/${VERSION}/opt/ad/lib/cmake
...
echo "class ad < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/ad/ad/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/ad/ad/releases/download/v${VERSION}\"
